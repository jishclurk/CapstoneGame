...
public class UnlockDoors : MonoBehaviour ,IGoal{

	public DoorSlideClock clockDoor;
	public DoorSlideConsole consoleDoor;
	...
	public bool IsAchieved() {
		return (clockDoor.isDoorOpen() || consoleDoor.isDoorOpen());
		//return false;
	}
