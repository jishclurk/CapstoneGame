...
public class PlayerAbilities : MonoBehaviour
{
    ...
    public void Awake()
    {
        potentialSpecials = new List<ISpecial>() {new GrenadeThrow(), new MedKit(), new Zap(), new BioGrenade(), new RIPRounds(), new ShieldBooster(), new Revive(), new SentryTurret(), new Flamethrower(), new Stimpak(), new Invigorate(), new ChainLightning(), new Shockwave(), new LeechDart()};
